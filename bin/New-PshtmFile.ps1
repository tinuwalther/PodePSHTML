            ...
            section -id "section" -Content {  
                ...
                div -id "Content" -Class "$($ContinerStyleFluid)" -Style "background-color:#142440" {
                    ...
                    div -Class "$($ContinerStyleFluid)" -Style "background-color:#142440" {
                        ...
                        h1 {"Bootstrap"} -Style "text-align: center"

                        p {
                            "[Bootstrap](https://getbootstrap.com/)"
                        } -Style "color:$TextColor" #f8f9fa

                        h2 {"How to update Bootstrap"} -Style "text-align: center"
                ...
                div -id "Content" -Class "$($ContinerStyleFluid)" -Style "background-color:#142440" {
                    ...
                    div -Class "$($ContinerStyleFluid)" -Style "background-color:#142440" {
                        ...
                        h1 {"NPM Packages"} -Style "text-align: center"

                        h2 {"CDNPKG"} -Style "text-align: center"
                        ...
                        h2 {"UNPKG"} -Style "text-align: center"
                        ...
                        h2 {"How to update JQuery"} -Style "text-align: center"
                        ...
                        h2 {"How to update Chart Bundle"} -Style "text-align: center"
