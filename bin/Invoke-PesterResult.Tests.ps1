...
Describe "Test PsNetTools" {
    ...
    it "Test-PsNetUping to <_> should return true" -Tag Ping -Skip -ForEach $TestCase {
    ...
    it "Test-PsNetWping to <_> should return true" -Tag Ping -ForEach $TestCase {
